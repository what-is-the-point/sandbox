...
class ConnectionFrameSerial(QGroupBox):
    ...
    def update_info(self, msg):
        self.model_lbl.setText(msg['model'])
        self.version_lbl.setText(msg['version'])
        self.track_lbl.setText(msg['mode'])
    ...
    def init_widgets(self):
        ...
        self.conn_status_lbl.setStyleSheet("QLabel {font:10pt; color:rgb(255,0,0);}")
        ...
        self.model_lbl = Qt.QLabel("")
        self.model_lbl.setAlignment(Qt.Qt.AlignLeft|Qt.Qt.AlignVCenter)
        self.model_lbl.setStyleSheet("QLabel {font:10pt; color:rgb(255,0,0);}")
        self.model_lbl.setFixedWidth(val_width)
        self.model_lbl.setFixedHeight(lbl_height)
        model_hbox = Qt.QHBoxLayout()
        model_hbox.addWidget(lbl)
        model_hbox.addWidget(self.model_lbl)
        model_hbox.addStretch(1)

        lbl = Qt.QLabel('Version:')
        lbl.setAlignment(Qt.Qt.AlignRight|Qt.Qt.AlignVCenter)
        lbl.setStyleSheet("QLabel {font:10pt; color:rgb(255,0,0);}")
        lbl.setFixedHeight(lbl_height)
        lbl.setFixedWidth(lbl_width)
        self.version_lbl = Qt.QLabel("")
        self.version_lbl.setAlignment(Qt.Qt.AlignLeft|Qt.Qt.AlignVCenter)
        self.version_lbl.setStyleSheet("QLabel {font:10pt; color:rgb(255,0,0);}")
        self.version_lbl.setFixedWidth(val_width)
        self.version_lbl.setFixedHeight(lbl_height)
        version_hbox = Qt.QHBoxLayout()
        version_hbox.addWidget(lbl)
        version_hbox.addWidget(self.version_lbl)
        version_hbox.addStretch(1)

        lbl = Qt.QLabel('T Mode:')
        lbl.setAlignment(Qt.Qt.AlignRight|Qt.Qt.AlignVCenter)
        lbl.setStyleSheet("QLabel {font:10pt; color:rgb(255,0,0);}")
        lbl.setFixedHeight(lbl_height)
        lbl.setFixedWidth(lbl_width)
        self.track_lbl = Qt.QLabel("")

...
class MainWindow(Qt.QMainWindow):
    ...
    def connect_signals(self):
        ...
        self.GoToSlewFrame.gotoSignal.connect(self._send_dev_command)
        self.GoToSlewFrame.stopSignal.connect(self._send_dev_command)
        self.GoToSlewFrame.querySignal.connect(self._send_dev_command)
    ...
    def _update_adsb_tracking(self, msg):
        ...
        if msg['tx_type']==3:
            ...
            self.GoToSlewFrame.update_target_angle(msg['azimuth'], msg['elevation'])
    ...
    def _update_device(self, msg):
        ...
        if msg['type']=='TLM':
            ...
            # print(self.dev_connected)
            self._update_dev_conn_status()
            self.ConnectionFrame.update_info(msg)
    ...
    def _update_gui(self):
        ...
        self.GoToSlewFrame.update_current_angle(self.cur_az, self.cur_el)
        self.GoToSlewFrame.update_command_angle(self.com_az, self.com_el)
    ...
    def _update_dev_conn_status(self):
        ...
        self.GoToSlewFrame.update_dev_conn_status(self.dev_connected)
    ...
    def init_frames(self):
        ...
        self.GoToSlewFrame  = GoToSlewFrame(az=self.cfg['azimuth'],el=self.cfg['elevation'], query_rate=self.cfg['query_rate'], parent=self)
    ...
    def init_tab(self):
        ...
        self.ctrl_tab.layout.addWidget(self.GoToSlewFrame   ,4,2,2,3)
        self.ctrl_tab.layout.addWidget(self.GoToFrame       ,4,5,2,3)

...
from PyQt5.QtCore import pyqtSignal, QPoint, QPointF, pyqtProperty, QRect, QRectF, QLineF
...
class JoystickFrame(QGroupBox):
    ...
    def initUI(self):
        ...
        self.AzJogRateSlider.setTickInterval(25)
        ...
        self.ElJogRateSlider.setTickInterval(25)
...
class Joystick(QWidget):
    ...
    def __init__(self, parent=None, az_rate_lim = 255, el_rate_lim=255):
        ...
        self._az_rate_max = self.az_rate_lim #current az jog max rate
        self.az_rate = 0
        self._az_dead_band = 5 #plus minus dead band for az joystick

        self.el_rate_lim = el_rate_lim #fixed upper limit for el jog rate
        self._el_rate_max = self.el_rate_lim #current el jog max rate
        self.el_rate = 0
        self._el_dead_band = 5 #plus minus dead band for az joystick
